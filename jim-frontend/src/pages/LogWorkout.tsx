...
const LogWorkout = () => {
  ...
  // Validate that all exercises have all sets with kg > 0 and reps > 0
      ...
      <div className="p-4 space-y-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <Button
            ...
            onClick={() => {
              // Check if all exercises have valid sets (kg > 0, reps > 0)
              if (exercises.length === 0 || !hasValidExercises()) {
                setShowAlert(true); // Show alert if any exercise has invalid sets
                return;
              }
